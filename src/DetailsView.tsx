    ...
    function visit (obj:any):any {
        ...
        switch (type(obj)) {
          ...
          case 'string':
            ...
            return <span className="json-markup-string">{maybeJson ? visit(maybeJson) : obj.replace(/\n/g, '\n' + indent)}</span>
    
          case 'link':
            return <span className="json-markup-string"><a href="' + escape(obj) + '">{escape(obj)}</a></span>
          ...
          case 'object':
            ...
            return forEach(keys, '{', '}', (key:any) => {
              return [<span className="json-markup-key" key={key}>{key}:</span>, visit(obj[key])]
            })
        }
